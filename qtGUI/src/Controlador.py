...
class Controlador(QtCore.QObject):
    ...
    def inicializar(self):
        u'''Inicializa o SIMPL. As mensagens a serem recebidas devem ser
    ...
    def processarFalhas(self, mensagem):
        u'''Função que processa as falhas ocorridas no envio das mensagens.'''
    ...
    def iniciarMedicao(self):
        ...
        '''
        print "Chegou no iniciarMedicao()" 
        ...
        Sensor2 = int(config['sensor2_conector'] != u'Tempo')
        ...
        m = ReadingStart(
                ...
                XY = Sensor2,
                nsensors = int(config['sensor2_conector'] != u'Tempo') + 1,
                n_passo = n_passo,
    ...
    def _getDriverNumber(self, conector, tipo):
        ...
        elif tipo == u'Resistência':
            return 8 if conector == u'EXT1' else 9
        
        else:
            return 5 if conector == u'EXT1' else 10
