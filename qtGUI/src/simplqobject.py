...
class SimplQObject(QtCore.QObject):
    ...
    def __init__(self, my_name, other_name='PICOMGR', parent=None):
        ...
        self.pSender = None
        self.pReceiver = None
        self.received.connect(printf)
        self.failed.connect(printf)
        QtCore.QTimer.singleShot(0, self._update)
        
        
    def start(self):
        u'''Inicializa o processo que recebe as mensagens do SIMPL.
    ...
    def _update(self):
        ...
        try:
            ...
            print 'Unrecognized token2: %d' % token
...
def _receiverTask(my_name, other_name, input_queue):
    ...
    try:
        ...
        print 'excecao no processo _receiverTask'
