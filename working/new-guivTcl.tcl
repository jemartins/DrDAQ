...
#####################################
## $Log: new-guivTcl.tcl,v $
## Revision 1.2  2007/06/09 02:11:45  jemartins
## validate entrys
##
## Revision 1.1  2007/06/08 23:09:30  jemartins
## initial revision
##
##
####################################
...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$base.lab47 {
        array set save {-activebackground 1 -background 1 -text 1}
    }
...
if {($Modo1 == "Pendulo") && ($Conector1 != "")} {
    ...
    button $site_3_0.but47 \
        -background #e6e7e6 -command {Window show .top52
focus .top52} \
    ...
    place $site_3_0.but47 \
        ...
        -bordermode ignore 
    label $top.lab63 \
        -background #e6e7e6 -text {Sensor 1:} 
    ...
    checkbutton $top.che65 \
        -background #e6e7e6 -variable Sensor1 
...
if {$Entradas} {
    ...
    place $site_3_0.lab91 \
        -in $site_3_0 -x 10 -y 9 -width 42 -height 20 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.cpd94 \
        -in $site_3_0 -x 124 -y 19 -width 72 -height 20 -anchor nw \
        -bordermode ignore 
    place $site_3_0.cpd95 \
        -in $site_3_0 -x 264 -y 19 -width 73 -height 20 -anchor nw \
        -bordermode ignore 
...
if {($Modo2 == "Pendulo") && ($Conector2 != "")} {
    ...
    button $site_3_0.but48 \
        -background #e6e7e6 -command {Window show .top53
focus .top53} \
        -state disabled -text calibrar 
...
Entry_TMax configure -state disabled} \
        -text Leituras: -value Leituras -variable Passo 
    ...
    place $site_3_0.cpd60 \
        ...
        -bordermode ignore 
    place $site_3_0.cpd61 \
        -in $site_3_0 -x 178 -y 50 -width 23 -height 22 -anchor nw \
        -bordermode ignore 
    place $site_3_0.cpd62 \
        -in $site_3_0 -x 195 -y 52 -width 80 -height 20 -anchor nw \
        -bordermode ignore 
    menu $top.m71 \
        -tearoff 1 
    button $top.cpd83 \
...
proc vTclWindow.top52 {base} {
    ...
    button $top.but54 \
        -command {Window hide .top52} -text Fechar 
    vTcl:DefineAlias "$top.but54" "OK1" vTcl:WidgetProc "PopUp1" 1
    button $top.but54.but55 \
        -activebackground #eff3f7 -background #eff3f7 \
        -highlightbackground #eff3f7 -text button 
...
if {($angulo11 == "")} { 
    ...
    hitCalibrate 0 $angulo11 1 $set_value
}} \
        -text OK 
...
if {($angulo12 == "")} { 
    ...
    hitCalibrate 0 $angulo12 1 $set_value
}} \
        -text OK 
    vTcl:DefineAlias "$top.cpd50" "Calib12" vTcl:WidgetProc "PopUp1" 1
    label $top.lab47 \
        -activebackground #eff3f7 -background #eff3f7 -text {Angulo 1} 
    vTcl:DefineAlias "$top.lab47" "Label_Angulo11" vTcl:WidgetProc "PopUp1" 1
    label $top.cpd51 \
        -activebackground #eff3f7 -background #eff3f7 -text {Angulo 2} 
    ...
    place $top.cpd50 \
        ...
        -bordermode inside 
    place $top.lab47 \
        -in $top -x 36 -y 32 -width 60 -height 20 -anchor nw \
        -bordermode ignore 
    place $top.cpd51 \
        -in $top -x 39 -y 71 -width 56 -height 20 -anchor nw \
        -bordermode ignore 
...
proc vTclWindow.top53 {base} {
    ...
    button $top.cpd57 \
        -command {Window hide .top53} -text Fechar 
...
if {($angulo21 == "")} { 
    ...
    hitCalibrate 1 $angulo21 2 $set_value
}} \
        -text OK 
...
if {($angulo22 == "")} { 
    ...
    hitCalibrate 1 $angulo22 2 $set_value
}} \
        -text OK 
    ...
    place $top.cpd54 \
        ...
        -bordermode inside 
    place $top.cpd55 \
        -in $top -x 41 -y 32 -width 56 -height 20 -anchor nw \
        -bordermode ignore 
    place $top.cpd56 \
        -in $top -x 41 -y 72 -width 56 -height 20 -anchor nw \
        -bordermode ignore 
